...
function formatCurrency(value, currency = "TRY") {
  ...
  if (currency === "USDT") {
    return `${new Intl.NumberFormat("tr-TR", { maximumFractionDigits: 6 }).format(number)} USDT`;
  }

...
function InvestmentsTab(p) {
  return (
    <>
      ...
      <Panel title="Yatırım Geliri" subtitle="Altın, hisse, kripto ve döviz takip paneli" totalLabel="Toplam Yatırım" total={money(p.investmentTotals.totalInvestment)} open={p.investmentOpen} onToggle={() => p.setInvestmentOpen((value) => !value)}>

...
export default function BesProjectionPanel() {
  ...
  const projection = useMemo(() => {
    ...
    const currentTotalMoney =
      currentPrincipalPaid + actualFundReturn + currentEarnedStateAmount;
    ...
    <section className="panelCard besProjectionPanel">
      ...
      >
        <div>
          ...
          <p>
            Gerçekleşen ana para, fon getirisi, devlet katkısı ve devlet katkısı
            fon getirisi ayrı takip edilir. Mevcut total para hesabında devlet
            tarafının %{vestingRate} oranı dahil edilir.
          </p>
        </div>

        <div className="panelRight">
          <div className="panelTotal">
            <span>Mevcut Total Para</span>
            <strong>{money(projection.currentTotalMoney)}</strong>
          </div>
        ...
        <div className="panelBody">
          <section className="summaryGrid investmentSummaryGrid">
            <article className="summaryCard green">
              <div className="summaryLabel">Mevcut Total Para</div>
              <div className="summaryValue summaryValue-green">
                {money(projection.currentTotalMoney)}
              </div>
              <div className="summaryDetail">
                Ana para + fon getirisi + devlet toplamının %{vestingRate} payı
              </div>
            </article>
            ...
            <article className="summaryCard red">
              <div className="summaryLabel">Hak Edilen Devlet Payı</div>
              <div className="summaryValue summaryValue-red">
                {money(projection.currentEarnedStateAmount)}
              </div>
              <div className="summaryDetail">
                Devlet katkısı + devlet fon getirisi x %{vestingRate}
              </div>
            </article>
          </section>
          ...
          <PanelBlock
            ...
            subtitle="Bugüne kadar gerçekleşen mevcut BES değerlerini buraya gir."
            color="purple"
            open={inputsOpen}
          ...
          >
            <div className="besLogicGrid">
              <div className="besLogicCard">
                <span>Gerçekleşen Ana Para</span>
                <strong>{money(projection.currentPrincipalPaid)}</strong>
                <p>BES hesabına bugüne kadar yatırılan veya plana göre hesaplanan ana para.</p>
              </div>
              ...
              <div className="besLogicCard">
                ...
                <strong>{money(projection.currentTotalMoney)}</strong>
                <p>
                  Ana para + fon getirisi + devlet toplamının %{vestingRate} hak edilen kısmı.
                </p>
              </div>
            </div>
          </PanelBlock>
